...
def book_value_computer(ticker):
        ...
        try:
            return ticker,book_value,EVtoEBITDA,priceToBookR,market_cap,priceToSales,previous_Close
        except:
...
list_clubber=[ticker_results,tickers_book_value,tickers_evtoebitda,tickers_priceToBook,tickers_marketcap,tickers_priceToSales,tickers_close]
